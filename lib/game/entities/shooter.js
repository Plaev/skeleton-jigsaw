...
.defines(function () {
    EntityShooter = ig.Entity.extend({
        ...
        shoot_sound: new ig.Sound( 'media/audio/shooter.*' ),
        ...
        init: function (x, y, settings) {
            ...
            this.addAnim('lavaidle', 1, [3]);
            this.addAnim('lavapreshoot', 1, [4]);
            this.addAnim('lavashooting', 1, [5]);
            this.applyFlip(settings);

            if (this.lava) {
                this.animidle     = this.anims.lavaidle;
                this.animpreshoot = this.anims.lavapreshoot;
                this.animshooting = this.anims.lavashooting;
            } else {
                this.animidle     = this.anims.idle
                this.animpreshoot = this.anims.preshoot
                this.animshooting = this.anims.shooting
            }
        ...
        update: function () {
            ...
            if (this.shootWaitTimer.delta() > 0) {
                ...
                this.currentAnim = this.animpreshoot;
            } else if (this.postshoot > 3) {
                this.currentAnim = this.animidle;
            }
            ...
            if (this.canShoot && this.shootTimer.delta() > 0) {
                ...
                this.currentAnim = this.animshooting;
                this.shoot();
                this.postshoot = 0;
            }
