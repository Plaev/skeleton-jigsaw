...
.defines(function(){
    EntityLavaanimation = ig.Entity.extend({
        ...
        init: function( x, y, settings ) {
            ...
            this.addAnim( 'state1', 0.15, [ 0,  1,  2,  3,  4,  5] );
            this.addAnim( 'state2', 0.15, [ 6,  7,  8,  9, 10, 11] );
            this.addAnim( 'state3', 0.15, [12, 13, 14, 15, 16, 17] );
            this.addAnim( 'state4', 0.15, [18, 19, 20, 21, 22, 23] );
