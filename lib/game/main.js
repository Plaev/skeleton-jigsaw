...
.defines(function(){
    ...
    TitleScreen = GameCommons.extend({
        gravity: 500,
        startKey: 'action',
        ...
        update: function() {
            ...
            if (ig.input.pressed(this.startKey)) {
                ig.music.stop();
                // FIXME: Use SkeletonJigsaw instead of Ending
                ig.system.setGame(Ending);
            }
        }
    });

    SkeletonJigsaw = GameCommons.extend({
        gravity: 500,
        hud: {},
        actionLock: false,
    ...
    Credits = ig.Class.extend({
        ...
        credits: [
            ...
            "",
            "",
            "Music", "Flesheaters by MATT NIDA", "chessboss by BERT FISK", "Crap-yo-pants by RAWMIN",
            "",
            "",
            "Plaev is Rafael Masoni and Willian Molinari",
            "Play Everywhere",
            "",
            "",
